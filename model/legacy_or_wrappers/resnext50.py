...
from resnext_backbones import build_resnext50_backbone, resnext50_preprocess_input


def main() -> None:
    parser = build_common_arg_parser(
        "Training klasifikasi Parkinson dengan ResNeXt-50-32x4d (Aggregated Residual Transformations)."
    )
    args = parser.parse_args()

    run_training_pipeline(
        model_name="resnext50",
        backbone_builder=build_resnext50_backbone,
        preprocess_fn=resnext50_preprocess_input,
        args=args,
    )
